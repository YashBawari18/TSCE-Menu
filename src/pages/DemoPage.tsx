          ...
          {demos.map((demo) => (
            ...
            >
              ...
              {currentDemo === demo.id && (
                <motion.div
                  layoutId="activeDemo"
                  className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-2xl border border-purple-500/30"
                />
              )}
            </motion.div>
          ))}
          ...
          <div className="relative bg-black rounded-2xl p-8 mb-6 min-h-[400px] flex items-center justify-center">
            ...
            {currentDemo === 'recipe-scaling' && (
              <div className="text-center w-full max-w-md">
                ...
                <div className="mb-6">
                  <label className="block text-gray-300 mb-2">Servings: {servings}</label>
                  <input
                    type="range"
                    min="1"
                    max="12"
